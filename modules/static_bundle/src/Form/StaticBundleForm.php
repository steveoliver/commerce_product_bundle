...
namespace Drupal\commerce_product_bundle_static\Form;
...
/**
 * Defines the static bundle add/edit form.
 *
...
class StaticBundleForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new StaticBundleForm object.
   *
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['#tree'] = TRUE;
    $form['#theme'] = ['commerce_product_bundle_form'];
   ...
   * @see \Drupal\node\NodeForm::form()
   */
  public static function updateStatus($entity_type, BundleInterface $product, array $form, FormStateInterface $form_state) {
